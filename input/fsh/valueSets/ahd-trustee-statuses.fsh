...
* ^status = #draft
* ^version = "1.0.0"
* http://hl7.org/fhir/task-status#requested "ootel"
* http://hl7.org/fhir/task-status#completed "kehtiv"
* http://hl7.org/fhir/task-status#rejected "tagasilükatud"
* http://hl7.org/fhir/task-status#cancelled "tühistatud"